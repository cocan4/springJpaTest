package com.springtest.serviceTesting;
...
import com.springtest.service.CompanyService;
import com.springtest.util.printTable;
...
public class CompanyServiceClr implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		printTable.print(companyService.getJobsBetweenDates((Date.valueOf("2010-11-20")), (Date.valueOf("2010-11-28"))));
